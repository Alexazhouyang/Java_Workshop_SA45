...
<head>
	...
	<title>Register For Stokist</title>
                                ...
                                <div class="content">
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                 <div >
                                        <label class="radio" ><input type="radio" name="role"placeholder="admin" checked="checked" value="admin">
                                        <a class="media" >Admin</a></label>
                                        <p></p>
                                 
                                        <label class="radio"><input type="radio" name="role"placeholder="mechanic"  value="mechanic">
                                       <a class="media"> Mechanic</a></label>
                                        </div>
                                    </div>
                                </div>
