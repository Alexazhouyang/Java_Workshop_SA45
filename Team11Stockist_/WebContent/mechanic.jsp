                            ...
                            <div class="content">
                                ...
                                <input type="hidden" name="role" class="form-control" placeholder="Role" value="<%=users.getRole()%>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <%-- <input type="hidden" name="role" class="form-control" value="<%=users.getRole()%>"/>  --%>
                                               <input type="hidden" name="userID" class="form-control"  value="<%=users.getUserID() %>"/>  
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" name="description" class="form-control" placeholder="Here can be your description" value="Here can be your description"> <%=users.getDescription()%></textarea>
                                            </div>
                                        </div>
                                    </div>
