                ...
                <div class="info">
                    ...
                    <div class="collapse" id="collapseExample">
                        <ul class="nav">
                            ...
                            <li><a href="mechanic.jsp">Settings</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                           ...
                           <div class="fixed-table-toolbar"><div class="bars pull-left"><div class="toolbar">
                            ...
                            <h1 ><p>Usage Report For UserNamer:<%=users.getUsername() %></p></h1> 
                            </div>
                            </div>
                            ...
                            <table id="bootstrap-table" class="table table-hover">
                                ...
                                <div class="fht-cell">
                                 ...
                                 <th class="text-center" style="" data-field="dateofUsage">
                                <div class="th-inner ">dateofUsage</div>
                                <div class="fht-cell">
                                </div></th>
                                <th class="text-center" style="" data-field="customerName">
                                <div class="th-inner ">CustomerName</div>
                                <div class="fht-cell">
                                </div></th>
                                <th class="text-center" style="" data-field="usage">
                                ...
                                <!-- list detail & operation -->
                                 ...
                                 for(int i = 0 ; i<list.size();i++) { 
                                	 ...
                                	 %>                                
                                <tr data-index="<%=tran.getTransactionID() %>" >
                                <td class="bs-checkbox" ></td>
                                
                                <td class="text-center"><font color="black"><%=tran.getProductID()%></font></td>
                                <td class="text-center"><font color="black"><%=tran.getDateofUsage() %></font></td>                              
                                <td class="text-center"><font color="black"><%=tran.getCustomerName() %></font></td>
                                <td class="text-center"><font color="black"><%=tran.getUsage() %></font></td>
